...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"simulation": {"kp": (-1.0, 1.0)}}, "simulation.kp must be non-negative"),
        ({"simulation": {"kd": (1.0, -0.5)}}, "simulation.kd must be non-negative"),
        ({"simulation": {"initial_q": (5.0, 0.6)}}, r"simulation.initial_q\[0\]=5.0 lies outside joint limits"),
        ({"simulation": {"target_q": (0.8, -3.5)}}, r"simulation.target_q\[1\]=-3.5 lies outside joint limits"),
        ({"simulation": {"dt": -0.1}}, "must be positive"),
        ({"esn": {"n_neurons": 0}}, "esn.n_neurons must be positive"),
        ({"esn": {"spectral_radius": -0.1}}, "esn.spectral_radius must be non-negative"),
        ({"esn": {"sparsity": 1.5}}, r"esn.sparsity must be in \[0, 1\]"),
        ({"esn": {"leak_rate": 0.0}}, r"esn.leak_rate must be in \(0, 1\]"),
        ({"esn": {"input_scaling": -1.0}}, "esn.input_scaling must be non-negative"),
        ({"esn": {"ridge_alpha": -1e-3}}, "esn.ridge_alpha must be non-negative"),
        ({"esn": {"washout": -1}}, "esn.washout must be non-negative"),
