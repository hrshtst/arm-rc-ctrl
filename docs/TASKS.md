...
- **Next task:** `M1-013` — scripted task 1-a demonstration + import command (in progress).
...
| M1-013 | `IN PROGRESS` | Record/import one external task 1-a demonstration and commit its immutable record | M1-010, M1-012 | Payload is absent from Git, record resolves and validates, and visual/manual review confirms intended reach/dwell |
