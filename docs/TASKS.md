...
- **Next task:** `M1-025`/`M1-026` — tune and freeze baseline gains (in progress).
...
| M1-026 | `IN PROGRESS` | Tune, review, and freeze computed-torque gains | M1-024 | Selected config, study summary, metrics, and provenance are committed/logged |
