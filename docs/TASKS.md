...
- **Next task:** `M1-028` — calibrate posture/force perturbation levels with the frozen baselines; then lock the confirmatory config and seed list.
...
| M1-028 | `IN PROGRESS` | Calibrate safe/nontrivial posture and force perturbation levels using frozen baselines | M1-025, M1-026 | Pilot report justifies levels; confirmatory config and seed list are then locked |
