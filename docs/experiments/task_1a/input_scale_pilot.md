...
Dataset `processed-20260830-feaf73e6663c`, scenario `configs/tasks/task_1a.toml`, model config `configs/models/esn_task_1a.toml`, commit `b41752f982a1`, trackers `computed_torque`, `pd_v2`.
...
- anchor: q scale 0.3 rad, dq scale 16 rad/s (highest feasible fraction among cells whose grid neighbours are all feasible; ties broken by lower median RMSE)
