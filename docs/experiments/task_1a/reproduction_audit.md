...
- evidence_project_commit: `19b9af3f5540f95cb594eb19b9ab6fa4e32b9fac`
...
- reproduction_project_commit: `c9cb57403c1ee34d328e0a122199a7501a11f2f6`
...
| --- | --- | --- | --- |
| environment | ok | 0.39 | 2 build identities verified; submodules ['rclib', 'rtctrl', 'skelarm'] and uv.lock match the evidence |
| storage | ok | 0.01 | external storage root resolved |
| records | ok | 0.06 | recipe esn-task-1a-v4, dataset processed-20260830-feaf73e6663c, raw raw-20260830-b5adde395f1c, 260 run pointers |
| payloads | ok | 0.11 | raw, processed, and 260 run payloads verified against their recorded digests |
| data | ok | 0.32 | processed dataset rebuilt with digest feaf73e6663c (identical) |
| model | ok | 0.08 | recipe refitted; fit RMSE 0.00173564 rad reproduced |
| evaluation | ok | 145.60 | 260 runs re-evaluated; largest deviation 0.000e+00 (tolerance 0.000e+00) |
| report | ok | 0.44 | report re-rendered identically from the committed evidence |
